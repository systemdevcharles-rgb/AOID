...
export default function AdminAssistantRegister() {
    ...
    const submit = (e) => {
        e.preventDefault();
        post(route('register.admin_assistant'), {
    ...
    return (
        <div className="flex min-h-screen flex-col items-center justify-center bg-[#f5f5f7] px-4 py-12">
            <Head title="Admin Assistant Registration" />
            ...
            <div className="w-full max-w-sm">
                ...
                <div className="overflow-hidden rounded-2xl border border-black/[0.06] bg-white shadow-sm">
                    <div className="border-b border-gray-100 px-6 py-5">
                        <p className="text-[17px] font-semibold text-gray-900">Admin Assistant Registration</p>
